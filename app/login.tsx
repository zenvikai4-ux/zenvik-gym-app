  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Forgot Password */}
        <Pressable onPress={() => { setShowForgot(s => !s); setForgotMsg(''); }} style={styles.forgotLink}>
          <Text style={styles.forgotLinkText}>{showForgot ? 'Cancel' : 'Forgot password?'}</Text>
        </Pressable>
        ...
        {showForgot && (
          <View style={styles.forgotBox}>
            ...
            {!!forgotMsg && (
              <Text style={[styles.forgotMsg, { color: forgotMsg.includes('sent') ? Colors.primary : Colors.danger }]}>{forgotMsg}</Text>
            )}
            <Pressable
              style={[styles.loginBtn, forgotLoading && styles.disabled, { marginTop: 10 }]}
...
const styles = StyleSheet.create({
  ...
  forgotLink: { alignSelf: 'center', marginTop: 12, padding: 4 },
  forgotLinkText: { fontFamily: 'Inter_500Medium', fontSize: 14, color: Colors.primary },
  forgotBox: { backgroundColor: Colors.card, borderRadius: 14, padding: 16, borderWidth: 1, borderColor: Colors.border, marginTop: 4 },
  forgotTitle: { fontFamily: 'Inter_700Bold', fontSize: 16, color: Colors.text, marginBottom: 4 },
  forgotSub: { fontFamily: 'Inter_400Regular', fontSize: 13, color: Colors.textSecondary, marginBottom: 12 },
  forgotMsg: { fontFamily: 'Inter_400Regular', fontSize: 13, marginTop: 8, textAlign: 'center' },
  footer: {
